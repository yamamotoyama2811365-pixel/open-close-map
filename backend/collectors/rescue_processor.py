...
def rescue_sources(database_url,batch_size=5):
    ...
    with psycopg.connect(database_url) as conn:
        with conn.cursor() as cur:
            ...
            for row in rows:
                ...
                if facts.get("quality")=="rejected_prefecture_mismatch":
                    rejected+=1
                ...
                cur.execute("""
                    ...
                    WHERE id=%s
                """,(real_url,addr,addr,facility,floor,floor,postal,postal,confidence,did))
    ...
    return {
        ...
        "rejected_prefecture_mismatch":rejected,
